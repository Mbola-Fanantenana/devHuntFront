...
const Authentification = () => {
    ...
    return (
        <div className="bg-[#ddd] min-h-screen flex flex-col space-x-2">
            <div className="flex items-center justify-center flex-grow">
                <div className='relative md:w-[40%] sm:w-[40%]'>
                    <p className="absolute flex items-center xl:text-4xl xl:block mt-10 text-[#323232] text-opacity-80 backdrop-blur-lg 2xl:text-[#323232] xl:text-[#323232] md:text-[#323232] lg:text-[#323232]">Découvrez la technologie différemment.</p>
                    ...
                    <p className="absolute flex items-center xl:text-4xl xl:block lg:block md:block sm:hidden -mt-20 text-[#323232] backdrop-blur-lg">Au-delà de votre imagination.</p>
                </div>
                <div className="space-y-3">
                    ...
                    <div className="w-full py-2 flex justify-center">
                        <Link
                            className="bg-[#007a55] bg-opacity-60 hover:bg-opacity-80 text-white py-2 px-4 rounded focus:outline-none text-lg font-medium" to={'/sign-up-with-faceID'}
                        >
