              ...
              >
                <div className="flex flex-row justify-between">
                  <div className="flex flex-row space-x-2">
                    <p className="text-lg font-bold cursor-pointer" onClick={() => setForumComment(item.idForum)}>{item.titre}</p>
                    <p className="text-[11px]">{item.heureForum}</p>
                  </div>
                ...
                <p className="flex items-center mt-2">
                  <div>
                    <button
                      ...
                      className={`px-2 rounded-lg ${userConnected === item.idUtilisateur ? 'visible' : 'hidden'}`}
                    >
